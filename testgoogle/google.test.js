...
test("can search Google twice", async () => {
  ...
  await driver.findElement(By.name('q')).sendKeys("hello there", Key.RETURN)
  ...
  await driver.findElement(By.name('q')).sendKeys("Bob Saget", Key.RETURN)
  // TODO Wait for the results page to load
  await driver.wait(until.titleIs("Bob Saget - Google Search"), 1000)
});
